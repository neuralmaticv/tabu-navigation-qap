# 🔍 Tabu Search for the Quadratic Assignment Problem (QAP)
...
**Presentation (in Serbian):** `presentation/tabu_search.pdf`

**Code:** `code/tabu_navigation.ipynb`

Instances of the QAP can be found in the `instances` directory, which are taken from the QAPLIB library except for the test ones.
